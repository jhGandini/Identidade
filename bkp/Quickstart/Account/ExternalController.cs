...
using Identidade.Server.Quickstart;
using IdentityModel;
...
namespace Identidade.Server.Quickstart.Account
{
    [SecurityHeaders]
    [AllowAnonymous]
    public class ExternalController : Controller
    {
        ...
        private async Task<(SeredeUser user, string provider, string providerUserId, IEnumerable<Claim> claims)>
        ...
        private async Task<SeredeUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
        {
